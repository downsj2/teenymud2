    ...
    char *argone, *argtwo;
{
  ...
  if(switches & LOCKOUT_CLEAR) {
    ...
    notify_player(player, cause, player, "Lockout lists cleared.", 0);
    return;
  }
  ...
  if(switches & LOCKOUT_ALL) {
    ...
    notify_player(player, cause, player, "All logins disabled.", 0);
    return;
  }
  ...
  if(switches & LOCKOUT_ENABLE) {
    ...
    notify_player(player, cause, player, "Logins enabled.", 0);
    return;
  }
  ...
  if((argone == (char *)NULL) || (argone[0] == '\0')) {
    notify_player(player, cause, player, "But who do you wish to lockout?", 0);
    return;
  }
  ...
  notify_player(player, cause, player, "Entry added.", 0);
}
