    ...
    int *clientData;
{
	...
	LIST_FORALL(hashList, hashEntryPtr) {		/* XLC */
#else
#if defined(__STDC__) && !defined(__GNUC__)
	LIST_FORALL(hashList, hashListPtr, hashEntryPtr, Hash_Entry) {/* ANSI */
#else
	LIST_FORALL(hashList, (List_Links *) hashEntryPtr) {	/* GNU/K&R */
#endif
#endif
	    j++;
	}
