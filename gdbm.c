...
static char *gdbm_unpack_data _ANSI_ARGS_((char *, char *, int));
static char *gdbm_unpack_lock _ANSI_ARGS_((struct boolexp **, char *));
static char *gdbm_unpack_string _ANSI_ARGS_((char **, char *));
...
static char *gdbm_pack_data(dest, source, size)
    char *dest, *source;
    int size;
{
...
static char *gdbm_pack_string(dest, src)
    char *dest, *src;
{
  int len;
...
static char *gdbm_unpack_data(dest, source, size)
    char *dest, *source;
    int size;
{
  bcopy((VOID *)source, (VOID *)dest, size);
...
static char *gdbm_unpack_string(dest, source)
    char **dest, *source;
{
  char *ptr = source;
