...
int Ltable_count = sizeof(Ltable) / sizeof(LockList);
...
int Atable_count = sizeof(Atable) / sizeof(StringList);
...
int AFlags_count = sizeof(AFlags) / sizeof(AFlagList);
...
int PlayerFlags_count = sizeof(PlayerFlags) / sizeof(FlagList);
...
int RoomFlags_count = sizeof(RoomFlags) / sizeof(FlagList);
...
int ThingFlags_count = sizeof(ThingFlags) / sizeof(FlagList);
...
int ExitFlags_count = sizeof(ExitFlags) / sizeof(FlagList);
...
int GenFlags_count = sizeof(GenFlags) / sizeof(FlagList);
